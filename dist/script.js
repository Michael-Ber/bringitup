...
/* harmony import */ var _modules_slider_main_slider_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/slider/main-slider.js */ "./src/js/modules/slider/main-slider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var sliderLoan = new _modules_slider_main_slider_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.page',
    btns: '.next'
  });
  sliderLoan.render();
  var sliderModules = new _modules_slider_main_slider_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.moduleapp',
    btns: '.next',
    navPrev: '.prevmodule',
    navNext: '.nextmodule'
  ...
  new _modules_form__WEBPACK_IMPORTED_MODULE_4__["default"]('.join__evolution .form').init();
  new _modules_form__WEBPACK_IMPORTED_MODULE_4__["default"]('.schedule__form .form').init();
  new _modules_accordeon__WEBPACK_IMPORTED_MODULE_5__["default"]('.plus', '.msg').init();
...
/*#__PURE__*/
function () {
  function Accordeon(trigger, content) {
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn, i) {
        btn.addEventListener('click', function () {
          if (window.getComputedStyle(_this.contents[i]).display !== 'block') {
            _this.contents[i].style.display = 'block';

            _this.contents[i].classList.add('animated', 'fadeInDown');
          } else {
            _this.contents[i].style.display = 'none';

            _this.contents[i].classList.remove('fadeInDown');
          }
        });
      });
    }
...
function () {
  ...
  _createClass(Difference, [{
    key: "bindTriggers",
    value: function bindTriggers(nodeElem, counter, items) {
      nodeElem.querySelector('.plus').addEventListener('click', function () {
    ...
    key: "hideItems",
    value: function hideItems(nodeElem) {
      nodeElem.forEach(function (item, i, arr) {
        if (i !== arr.length - 1) {
...
function () {
  ...
  _createClass(Download, [{
    ...
    value: function downloadFile(path) {
      // данный метод создает виртуальную ссылку, которая позволяет
      var link = document.createElement('a'); // скачать файл. Этот метод используется
...
function (_Slider) {
  ...
  function MainSlider(btns, navPrev, navNext) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btns, navPrev, navNext));
  }
  ...
  _createClass(MainSlider, [{
    ...
    value: function bindtriggers() {
      ...
      if (this.container) {
        // чтобы не было ошибки, т.к один класс .next для sliderLoan и sliderModules
        try {
        ...
        this.navPrev.forEach(function (btn) {
        ...
        this.navNext.forEach(function (btn) {
          btn.addEventListener('click', function (e) {
            e.stopPropagation();
            e.preventDefault();
  ...
  _createClass(SliderMini, [{
    ...
    value: function nextSlide() {
      ...
      this.next.addEventListener('click', function () {
        for (var i = 1; i < _this3.slides.length - 1; i++) {
      ...
      document.querySelector('.difference .next').addEventListener('click', function () {
        _this3.nextByInterval();
      });
    }
  }, {
    key: "prevSlide",
    ...
    key: "nextByInterval",
    value: function nextByInterval() {
      var _this5 = this;

      if (this.autoplay) {
        this.timerID = setInterval(function () {
          _this5.container.appendChild(_this5.slides[0]); // this.nextArrElem(this.slides);
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$navNext = _ref.navNext,
      navNext = _ref$navNext === void 0 ? null : _ref$navNext,
      _ref$navPrev = _ref.navPrev,
      navPrev = _ref$navPrev === void 0 ? null : _ref$navPrev,
      ...
      this.btns.forEach(function (btn, i) {
        ...
        btn.addEventListener('click', function () {
          if (!btn.closest('.module__video-item') || btn.closest('.module__video-item').getAttribute('data-disabled') !== 'true') {
            // первое условие чтобы не было ошибки на странице loan
            _this.activeBtn = btn;
